...
/* Extra standard headers for safer numerical and memory handling in robust builds */
#include <float.h>
#include <math.h>
#include <stddef.h>
#include <string.h>

#ifndef _PERTURBATIONS_ROBUST_EPS_
#define _PERTURBATIONS_ROBUST_EPS_ 1e-300
#endif

#ifndef _PERTURBATIONS_ROBUST_ABS_
#define _PERTURBATIONS_ROBUST_ABS_(x) (fabs((double)(x)))
#endif

#ifndef _PERTURBATIONS_ROBUST_FINITE_
#define _PERTURBATIONS_ROBUST_FINITE_(x) isfinite((double)(x))
#endif

#ifndef _PERTURBATIONS_ROBUST_NONZERO_
#define _PERTURBATIONS_ROBUST_NONZERO_(x) (_PERTURBATIONS_ROBUST_ABS_(x) > _PERTURBATIONS_ROBUST_EPS_)
#endif
...
#define _set_source_(index) \
  (ppt->sources[index_md][index_ic * ppt->tp_size[index_md] + (index)] \
