/** @file background_modified_robust.h Documented includes for robust background module */
...
struct background
{
  ...
  double scf_veta; /** momentum transfer coupling parameter (robust implementation guarded in background.c) **/
  ...
  int index_bg_lambda_eff_scf;/**< effective slope lambda_eff(phi) */
  int index_bg_rho_scf;       /**< scalar field energy density */
  int index_bg_p_scf;         /**< scalar field pressure */
  int index_bg_w_phi_scf;     /**< scalar field equation of state w_phi = p_scf/rho_scf */
  int index_bg_p_prime_scf;   /**< scalar field pressure derivative */
  ...
  int index_bg_w_eff;         /**< total effective equation of state w_eff = p_tot/rho_tot */
  ...
  /** @name - flags describing the absence or presence of cosmological ingredients */
