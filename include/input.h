...
/* Extra standard headers for robust parsing and numerical checks */
#include <math.h>
#include <float.h>
#include <string.h>
...
/* Small helper macros used by the robust input parser implementation. */
#ifndef _CLASS_FINITE_
#define _CLASS_FINITE_(x) (isfinite((x)))
#endif

#ifndef _CLASS_SAFE_ABS_
#define _CLASS_SAFE_ABS_(x) (fabs((x)))
#endif
...
enum target_names {theta_s, Omega_dcdmdr, omega_dcdmdr, Omega_scf, Omega_ini_dcdm, omega_ini_dcdm, sigma8, lambda_eff};
enum computation_stage {cs_background, cs_thermodynamics, cs_perturbations,
                        cs_primordial, cs_nonlinear, cs_transfer, cs_spectra};
#define _NUM_TARGETS_ 8 /* Keep synchronized with enum target_names for robust shooting logic */
